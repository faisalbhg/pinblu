...
<div class="bubbles-container" id="bubbles">
	<div style="top: 60.3%; margin-left: -2.1%;">
		<img src="<?=base_url('assets/images/bubbles-06.png');?>" class="bubbles-response-03" alt="">
	</div>
	<div style="top: 52.3%; margin-left: -5.3%;">
		<img src="<?=base_url('assets/images/stars-01.png');?>" class="bubbles-stars"  alt="">
	</div>
	<div style="top: 39.5%; margin-left: 0.7%;">
		<img src="<?=base_url('assets/images/bubbles-03.png');?>" class="bubbles-response-03" alt="">
	</div>
	<div style="top: 26.5%; margin-left: -3.8%;">
		<img src="<?=base_url('assets/images/bubbles-05.png');?>" alt="">
	</div>
	<div style="top: 11.4%; margin-left: 0.7%;">
		<img src="<?=base_url('assets/images/bubbles-01.png');?>" class="bubbles-response-01"  alt="">
	</div>
	<div style="top: 81%; margin-left: -1.5%;">
		<img src="<?=base_url('assets/images/bubbles-07.png');?>" alt="">
	</div>
	<div style="top: 54.8%; margin-left: -2.3%;">
		<img src="<?=base_url('assets/images/bubbles-09.png');?>" alt="">
	</div>
	...
	<div style="top: 68.2%; margin-left: 1.3%;">
		<img src="<?=base_url('assets/images/bubbles-10.png');?>" alt="">
	</div>
	<div style="top: 67.2%; margin-left: 0.1%;">
		<img src="<?=base_url('assets/images/bubbles-02.png');?>" class="bubbles-response-02" alt="">
	</div>
	<div style="top: 77.2%; margin-left: 1.2%;">
		<img src="<?=base_url('assets/images/bubbles-11.png');?>" alt="">
	</div>
	...
	<div style="top: 7.8%; margin-left: 4.1%;">
		<img src="<?=base_url('assets/images/bubbles-08.png');?>" alt="">
	</div>
