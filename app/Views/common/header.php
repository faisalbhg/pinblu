               ...
               <div class="tt-holder">
                  <div class="tt-col-left">
                     <!-- logo --> <a href="<?=base_url();?>" class="tt-logo tt-logo-alignment">
                        ...
                        <span class="tt-base-color">Pink &</span>Blue</a>
                     <!-- /logo -->
                  </div>
                     ...
                     <div class="tt-col__item  d-none">
                        ...
                        <nav id="tt-nav">
                           <ul>
                              ...
                              <li>
                                 <a href="<?=base_url('contact-us');?>">REACH US</a>
                              </li>
                  ...
                  <div class="tt-col-right tt-col-objects">
                     ...
                     <div class="tt-col__item "><!--d-block d-lg-none-->
                        <div class="h-info02">
                           <div class="tt-item">
                              <address><a href="tel:+971 800 99900"><span class="icons-483947"></span> 800 PINKBLUE</a></address>
                           </div>
                        </div>
                     </div>
                     <div class="tt-col__item "><!--d-block d-lg-none-->
                        <div class="h-info02">
                           <div class="tt-item">
                              <address><a href="https://wa.me/+971566993709">
                                 <script defer src="https://use.fontawesome.com/releases/v5.2.0/js/all.js"></script><i class="fab fa-whatsapp"></i></a></address>
                           </div>
                        </div>
                     </div>
                     <div class="tt-col__item d-none">
