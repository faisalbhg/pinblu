...
<html lang="en">
   ...
   <body>
      ...
      <main id="tt-pageContent">
            ...
            <div class="container container-fluid-xl">
               <div class="box01">
                  <div class="box01__img">
                     <img src="data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAfoAAAHtAQMAAADLCC4pAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAADZJREFUeNrtwTEBAAAAwiD7p7bDbmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAxQF9LQABorKvFgAAAABJRU5ErkJggg==" class="lazyload" data-src="<?=base_url('assets/images/img01.jpg');?>" alt="">
                     <img class="tt-arrow lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/arrow-img-right.png');?>" alt="">
         ...
         <div class="lazyload bg-top-right" data-bg="<?=base_url('assets/images/wrapper02.png');?>">
                  ...
                  <div class="slick-default slick-arrow-align imgbox-inner__wrapper" data-slick='{
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner svg-animation-01">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img01.jpg');?>" class="lazyload" alt="">
                           </div>
                              ...
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
                                    <svg class="svg-vacuumcleaner-icon animated-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="300" height="300" viewBox="0 0 39 32">
                                       ...
                                       <path class="vacuumcleaner" d="M7.049 20.883c-3.069 0-5.558 2.49-5.558 5.558s2.49 5.558 5.558 5.558c3.069 0 5.558-2.49 5.558-5.558s-2.49-5.558-5.558-5.558zM7.049 29.468c-1.67 0-3.026-1.356-3.026-3.026s1.356-3.026 3.026-3.026c1.67 0 3.026 1.356 3.026 3.026s-1.356 3.026-3.026 3.026z">
                                       </path>
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner svg-animation-02">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img02.jpg');?>" class="lazyload" alt="">
                           </div>
                           <div class="imgbox-inner__description">
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner svg-animation-03">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img03.jpg');?>" class="lazyload" alt="">
                           </div>
                           <div class="imgbox-inner__description">
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img04.jpg');?>" class="lazyload" alt="">
                           </div>
                           <div class="imgbox-inner__description">
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img05.jpg');?>" class="lazyload" alt="">
                           </div>
                           <div class="imgbox-inner__description">
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
                     ...
                     <div class="tt-item">
                        <a href="services-item.html" class="imgbox-inner">
                           <div class="imgbox-inner__img">
                              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAlgAAAIIAQMAAACIJgJoAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAD1JREFUeNrtwTEBAAAAwiD7pzbDfmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAACQHmmAAAa/2RGEAAAAASUVORK5CYII=" data-src="<?=base_url('assets/images/imgbox-inner__img06.jpg');?>" class="lazyload" alt="">
                           </div>
                           <div class="imgbox-inner__description">
                              <div class="imgbox-inner__row">
                                 <div class="imgbox-inner__icon">
               ...
               <div class="container container-fluid-lg">
                  <div class="row align-items-center stepbox_wrapper" style="overflow: hidden;">
                     <div class="col-md-6 col-lg-5 stepbox__layout">
                        <img class="tt-arrow lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/arrow-img-right02.png');?>" alt="">
                        <div class="title-block">
                     ...
                     <div class="col-md-6 col-lg-6 offset-lg-1">
                        <div class="slider-stepbox" id="js-stepbox__layout">
                           <div class="tt-item active" data-number="1">
                              <div class="stepbox">
                                 <div class="stepbox__img">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/stepbox-img01.png');?>" alt="">
                                 </div>
                                 <div class="stepbox__content">
                                    <div class="stepbox__number">01</div>
                                    <div class="stepbox__limitation">
                                       <h6 class="stepbox__title">
                                          <span class="tt-base-color">Bag Up</span> All Your Dirty Clothes
                                       </h6>
                           ...
                           <div class="tt-item" data-number="2">
                              <div class="stepbox">
                                 <div class="stepbox__img">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/stepbox-img02.png');?>" alt="">
                                 </div>
                                 <div class="stepbox__content">
                                    <div class="stepbox__number">02</div>
                                    <div class="stepbox__limitation">
                                       <h6 class="stepbox__title">We <span class="tt-base-color">Pick Up</span>
                                          Your Clothes
                                       </h6>
                           ...
                           <div class="tt-item" data-number="3">
                              <div class="stepbox">
                                 <div class="stepbox__img">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/stepbox-img03.png');?>" alt="">
                                 </div>
                                 <div class="stepbox__content">
                           ...
                           <div class="tt-item" data-number="4">
                              <div class="stepbox">
                                 <div class="stepbox__img">
                                    <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/stepbox-img04.png');?>" alt="">
                                 </div>
                                 <div class="stepbox__content">
                        ...
                        <div class="stepbox-dots__wrapper" id="js-stepbox__nav" data-number="1">
                           <div class="stepbox-dots__line01 lazyload" data-bg="<?=base_url('assets/images/step-line-x.png');?>"></div>
                           <div class="stepbox-dots__line02 lazyload" data-bg="<?=base_url('assets/images/step-line2-x.png');?>"></div>
         ...
         <div class="tt-position-relative bg-top-left move-bottom-top lazyload" data-bg="<?=base_url('assets/images/wrapper03.png');?>">
            <div class="section-inner">
               <div class="box02 box02__img-left">
                  <div class="box02__img">
                     <picture>
                        <source srcset="<?=base_url('assets/images/box02-img01-sm.webp');?>" media="(max-width: 650px)" type="image/webp">
                        <source srcset="<?=base_url('assets/images/box02-img01-sm.jpg');?>" media="(max-width: 650px)" type="image/png">
                        <source srcset="<?=base_url('assets/images/box02-img01-md.webp');?>" media="(max-width: 1024px)" type="image/webp">
                        <source srcset="<?=base_url('assets/images/box02-img01-md.jpg');?>" media="(max-width: 1024px)" type="image/png">
                        <source srcset="<?=base_url('assets/images/box02-img01.webp');?>" type="image/webp">
                        <source srcset="<?=base_url('assets/images/box02-img01.jpg');?>" type="image/png">
                        <img src="dimages/box02-img01.jpg" alt="">
                     </picture>
                     <img class="tt-arrow lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/arrow-img-right03.png');?>" alt="">
                  </div>
            ...
            <div class="tt-position-relative">
               <div class="lazyload tt-obj01-bg" data-bg="<?=base_url('assets/images/wrapper04.png');?>"></div>
               <div class="section-indent no-margin">
                  <div class="container container-fluid-lg">
                     <div class="title-block text-center">
                     ...
                     <div class="tabs-default tab-layout01">
                        <div class="tt-ajax-tabs">
                           <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tt-tab-02" role="tab" data-ajax-include="ajax-content/tabs-questions-answers.html">Questions / Answers</a></li>
                              <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tt-tab-03" role="tab" data-ajax-include="ajax-content/tabs-why-choose-us.html">Why Choose Us</a></li>
                           </ul>
                        </div>
                           ...
                           <div class="tab-pane active fade" id="tt-tab-01" role="tabpanel">
                              <div class="row align-items-lg-center">
                                 <div class="col-sm-6 col-lg-5">
                                    ...
                                    <p>Clients benefit from consistent service delivery with greater cost and quality control as well as more efficient use of their operational and financial resources.</p>
                                 </div>
                                 ...
                                 <div class="col-sm-6 col-lg-6 offset-lg-1 text-right">
                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="tt-obj-video js-video-popup">
                                       <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/video-img01.jpg');?>" alt="">
            ...
            <div class="tt-position-relative">
               <div class="section-indent">
                  <div class="lazyload tt-obj02-bg" data-bg="<?=base_url('assets/images/wrapper05.png');?>"></div>
                  <div class="container">
                     <div class="title-block text-center">
                        <div class="title-block__label">[ Affordable Prices ]</div>
                        <h4 class="title-block__title">Our Dry Cleaning & Laundry Prices</h4>
                        <div class="title-block__text">Our prices are simple and affordable which are easy on pocket<br>in comparison with the high street prices</div>
                     </div>
               ...
               <div class="blog-slider" id="blog-slider">
                  <div class="blog-slider__img">
                     <div class="tt-item-wrapper">
                        <div class="tt-item"><i><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/quotes-img01.png');?>" alt=""></i><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/blog-slider-img01.jpg');?>" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/quotes-img01.png');?>" alt=""></i><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/blog-slider-img02.jpg');?>" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/quotes-img01.png');?>" alt=""></i><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/blog-slider-img03.jpg');?>" alt=""></div>
                        <div class="tt-item"><i><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?=base_url('assets/images/quotes-img01.png');?>" alt=""></i><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" class="lazyload" data-src="<?=base_url('assets/images/blog-slider-img04.jpg');?>" alt=""></div>
                     </div>
                  </div>
                  <div class="blog-slider__layout slick-default slick-dots-left">
                     <div class="tt-item">
                        ...
                        <blockquote>
                           <p>"This was my first time coming to a Laundromat ever. I was greeted by a woman with a warm smile. I was looking around and she could tell I needed help. She started me up with purchasing a Laundry Card. She then gave me recommendations per the clothes I had. She was so helpful and friendly. Being new to the city this is now my go to. Very clean and up date machines. :)"</p>
                     ...
                     <div class="tt-item">
                        ...
                        <blockquote>
                           <p>"I was skeptical about leaving my clothes to be washed dried and folded by someone I did not know, and let me tell you I was beyond amazed by the quality they put into the process of washing drying and folding. It was packaged and put back into the bin I delivered my dirty clothes in, and was notified through email and text when it was ready!"</p>
         ...
         <div class="tt-position-relative tt-overflow-hidden">
            <div class="lazyload tt-obj03-bg" data-bg="<?=base_url('assets/images/wrapper06.png');?>"></div>
            <div class="section-indent">
               <div class="container container-fluid-lg">
                  <div class="title-block text-center">
                  ...
                  <div class="promo02__wrapper row js-init-carusel-tablet slick-default">
                     ...
                     <div class="tt-item col-md-4">
                        <div class="promo02 js-handler">
                           ...
                           <div class="promo02__price"><span class="old-price">$449.00</span> <span class="new-price">$449.00</span></div>
                           <div class="promo02__show-btn">
                              <a href="#" class="tt-btn tt-btn__wide">
                                 <span class="mask">Order Now</span>
                                 <div class="button">Order Now</div>
